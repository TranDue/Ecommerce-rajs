            ...
            <div class="card text-center">
                ...
                <div className="row">
                    ...
                    <div className="contact-content col-lg-8">
                        <h2 class="contact-name m-5">TranDue</h2>
                        <p><a href="/"><i class="fa fa-envelope-square"></i>trandue@gmail.com</a></p>
                        <p><a href="https://github.com/TranDue"><i class="fa fa-github" />Thông tin qua Github</a></p>
                        <p><a href="/"><i class="fa fa-linkedin"></i>Thông tin qua Linkedin</a></p>
                        <span>TP HCM</span>
                    </div>
                </div>
